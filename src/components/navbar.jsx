...
const NavBar = () => {
  ...
  return (
    <>
      <header className="navbar flex justify-between items-center xs:px-1 py-2 sticky top-0 border-2 bg-white rounded-b-lg z-10">
        ...
        <div className="utilities-section flex items-center lg:w-50 xl:w-[395px]">
          ...
          <div className="signup-wrapper xs:ml-1.5 mr-.6 sm:ml-2.5 sm:mr-1 lg:ml-3">
            <NavLink to="login">
