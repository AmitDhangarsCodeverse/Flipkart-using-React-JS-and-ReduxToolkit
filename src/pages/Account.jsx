...
const Account = ({ storedValue, setValue }) => {
  ...
  return (
    <>
      <div className="account-wrapper flex justify-center bg-white rounded-lg shadow-md shadow-gray-400 border border-blue-200 xs:m-1 xs:p-2.5 md:m-2 lg:m-3 lg:p-2.5">
        <div className="account-details flex flex-col items-center border rounded-lg border-red-300 shadow-md shadow-red-300">
          <div>
            <img
          ...
          <div className="xs:mb-3">
            <button onClick={logout} className="bg-red-400 rounded-sm xs:p-1">
