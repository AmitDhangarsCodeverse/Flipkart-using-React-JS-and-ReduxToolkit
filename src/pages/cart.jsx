...
const Cart = () => {
  ...
  return (
    <>
      <div className="cart-wrapper bg-white rounded-md shadow-md shadow-red-200 xs:m-1 p-1.5 lg:m-1 xl:m-3">
              ...
              <div className="product-wrapper flex items-start justify-center xs:flex-col xs:mb-1 w-[100%]">
                ...
                >
                  ...
                  <div className="btn flex items-center xs:w-[10%] p-2 m-1">
                    <button
                      className="bg-orange-400 xs:rounded-sm xs:mr-1 p-0.5 md:rounded-sm md:mr-2 md:px-2 py-1"
                      onClick={() => {
                        buyNow(prod);
                      }}
                    >
